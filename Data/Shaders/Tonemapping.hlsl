...
// > Create Time: 2025-06-07 15:50:07
//
...
void CSMain(uint3 tid: SV_DispatchThreadID)
{
    ...
    Texture2D<float4> hdr = BindlessTexture2DFloat4_Load(Push.HDR);
    RWTexture2D<float4> ldr = BindlessRWTexture2DFloat4_Load(Push.LDR);
